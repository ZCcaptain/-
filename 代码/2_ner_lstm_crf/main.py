...
class Runner(object):
    ...
    def evaluation(self):
        ...
        with torch.no_grad():
            ...
            with open(str(self.gpu) + 'log.log', 'a+') as f:
                f.write(res)
                f.write('\n')
            print('Triplets-> ' +  ', '.join([
                "%s: %.4f" % (name[0], value)
    ...
    def train(self):
        ...
        loader = Selection_loader(train_set, batch_size=self.hyper.train_batch, pin_memory=True, shuffle=True)
